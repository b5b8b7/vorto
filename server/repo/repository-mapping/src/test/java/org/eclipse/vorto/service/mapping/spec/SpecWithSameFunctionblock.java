...
public class SpecWithSameFunctionblock extends AbstractTestSpec {
	...
	protected void createFBSpec() {
		...
		digitalInputStateProperty.addStereotype(Stereotype.createWithXpath("source", "/@btnvalue1"));
		...
		digitalInputStateProperty2.addStereotype(Stereotype.createWithXpath("source", "/@btnvalue2"));
